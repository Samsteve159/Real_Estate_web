    ...
    <section className="mx-auto max-w-7xl px-6 py-24">
      ...
      <div className="mt-14 grid gap-6 md:grid-cols-2">
        <ToolCard
          ...
          body="Enter an address and a few details. Claude reasons over recently-sold comparables and suburb medians to return an honest indicative range — then invites the owner to book a real appraisal."
          to="/valuation"
