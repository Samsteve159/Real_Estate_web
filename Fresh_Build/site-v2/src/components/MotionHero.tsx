  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-24 pt-36">
        ...
        {/* Eyebrow — the service spread */}
        <p
          className="rise delay-100 mb-6 eyebrow"
          style={{ color: "var(--color-gold)", fontSize: "0.8rem" }}
        >
          Residential Sales • Acreages • Development Projects • Commercial Leasing
        </p>
        ...
        >
          ...
          <br />
          <span className="conviction">Results.</span>
        </h1>
        ...
        >
          Manifest Real Estate is a boutique property agency and advisory business helping clients buy, sell, lease and invest with confidence. We combine local market knowledge with strategic advice to deliver outcomes that create long-term value.
        </p>
