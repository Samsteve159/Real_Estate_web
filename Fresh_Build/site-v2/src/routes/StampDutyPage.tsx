      ...
      <div ref={ref as React.RefObject<HTMLDivElement>} className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="reveal mt-16">
          ...
          <p className="text-xs mt-6" style={{ color: "var(--color-dim)", maxWidth: "60ch", lineHeight: 1.6 }}>
            ...
            further reduce your duty. <Link to="/contact" className="gold-underline" style={{ color: "var(--color-gold)" }}>Speak to a RE representative</Link> to check what you qualify for.
          </p>
        </div>
      </div>
    </div>
