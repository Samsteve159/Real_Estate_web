...
- **Real assets to swap**: Akshay's hero footage (`site/public/hero/hero.mp4`) and/or a real B&W skyline photo (`site/public/hero/melbourne-skyline.jpg`); white/mono logo SVG if available; About page photo + bio; Contact phone/email.
