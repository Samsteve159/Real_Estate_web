    ...
    <div style={{ background: "var(--color-bg)", paddingTop: "6rem" }}>
      <div ref={ref as React.RefObject<HTMLDivElement>} className="max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="reveal">
          ...
          <p className="mb-10" style={{ color: "var(--color-muted)", maxWidth: "48ch", lineHeight: 1.7 }}>
            Whether you're buying, selling, leasing or exploring your next investment, we're here to help.
            Get in touch to discuss your property goals and discover how Manifest Real Estate can assist.
          </p>
