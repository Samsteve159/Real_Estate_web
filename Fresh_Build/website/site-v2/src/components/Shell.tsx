...
/* ------------------------------------------------------------------ *
 *  Visible labels: Listings · Services · First home buyers · Tools ·
 *  About · Contact. SERVICE_LINKS / TOOL_LINKS drive the mobile menu's
 *  expandable groups (the desktop nav uses the mega-menu components).
 * ------------------------------------------------------------------ */
const SERVICE_LINKS = [
  { label: "Residential Sales", to: "/services/residential-sales" },
  { label: "Acreage & Lifestyle", to: "/services/acreage-lifestyle" },
  { label: "Development Projects", to: "/services/development-projects" },
  { label: "Commercial Leasing", to: "/services/commercial-leasing" },
  { label: "Property Advisory", to: "/services/property-advisory" },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm leading-relaxed max-w-xs" style={{ color: "var(--color-muted)" }}>
                A boutique property agency and advisory business helping clients buy, sell, lease and invest with confidence across Melbourne.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3">
                {[
                  ["Residential Sales", "/services/residential-sales"],
                  ["Acreage & Lifestyle", "/services/acreage-lifestyle"],
                  ["Development Projects", "/services/development-projects"],
                  ["Commercial Leasing", "/services/commercial-leasing"],
                  ["Property Advisory", "/services/property-advisory"],
                ].map(([label, to]) => (
                  <li key={to}>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3">
                {[
                  ...
                  ["Borrowing Capacity", "/tools/pre-buying"],
